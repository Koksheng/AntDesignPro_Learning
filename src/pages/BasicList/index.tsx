...
//   };
// // console.log(init);
// // if(!Array.isArray(init?.data?.dataSource) && init?.loading == false){
// //   console.log("results are not array");
// //   var temp1 = [];
// //   temp1[0] = init?.data?.dataSource;
// //   init.data.dataSource = temp1;
// // }else{
// //   console.log("results are array");
// // }
//   return (
//     <PageContainer>
//       {searchLayout()}
...
//           rowKey="id"
//           dataSource={init?.data?.dataSource}
//           columns={ColumnBuilder(init?.data?.layout?.tableColumn ? init?.data?.layout?.tableColumn : init?.data?.layout?.tabs[0].data, actionHandler)}
//           pagination={false}
//           loading={init?.loading}
//           onChange={tableChangeHandler}
//           rowSelection={rowSelection}
